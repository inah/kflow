	...
	public GraphView(Graph g, String label) {
		...
		addNodeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int randomNodeIndex = rn.nextInt(nodecount - 1 + 1) + 1;

				Node node_a = g.addNode();
				node_a.set("label", ""+randomNodeIndex);
				
				Node node_b = g.getNode(randomNodeIndex);
